...
% TODO add Q (and alternative symbol definitions \alpha = 1/Q and \zeta = 2\alpha), the quality factor from page 8.7: If Q is > 0.707, there will be some peaking in the filter response. If the Q is < 0.707, rolloff at F0 will be greater; it will have a more gentle slope and will begin sooner
