...
\begin{equation*}
	0 = \sum_{x=1}^{n}\iin[x] = \sum_{x=1}^{n}\frac{\vin[x] - v\sub{+}}{R_x} \implies \sum_{x=1}^{n}\frac{\vin[x]}{R_x} = \sum_{x=1}^{n}\frac{v\sub{+}}{R_x} = v\sub{+}\sum_{x=1}^{n}\frac{1}{R_x} \implies v\sub{+} = \left(\sum_{x=1}^{n}\frac{1}{R_x}\right)^{-1}\left(\sum_{x=1}^{n}\frac{\vin[x]}{R_x}\right)
\end{equation*}
...
\begin{equation}
	\vout = \left(1 + \frac{\R[F]}{\R[G]}\right)\left(\sum_{x=1}^{n}\frac{1}{R_x}\right)^{-1}\left(\sum_{x=1}^{n}\frac{\vin[x]}{R_x}\right)
...
\begin{equation*}
	\left(\sum_{x=1}^{n}\frac{1}{R}\right)^{-1}\left(\sum_{x=1}^{n}\frac{\vin[x]}{R}\right) = \left(\frac{n}{R}\right)^{-1}\left(\frac{1}{R}\sum_{x=1}^{n}\vin[x]\right) = \frac{1}{n}\sum_{x=1}^{n}\vin[x]
\end{equation*}
