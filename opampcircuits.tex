...
\begin{center}
	\begin{circuitikz}
		...
		(opamp.out) to[short,*-o] ++(1,0)
		(VG) to[short, -*] ++(-1,0) coordinate(vin_junction) to[short] ++(-0.5,0.5) to[R,l_=$R_1$] ++(-2,0) to[short,-o] ++(-0.5,0) node[above]{\vin[1]}
		(vin_junction) to[short] ++(-0.5,-0.5) to[R,l_=$R_2$] ++(-2,0) to[short,-o] ++(-0.5,0) node[above]{\vin[2]}
