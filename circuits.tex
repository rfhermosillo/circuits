...
\NewDocumentCommand\vin{}{\ensuremath{v_i}\xspace}
\NewDocumentCommand\rin{}{\ensuremath{R_i}\xspace}
\NewDocumentCommand\vout{}{\ensuremath{v_o}\xspace}
\NewDocumentCommand\rout{}{\ensuremath{r_o}\xspace}
\NewDocumentCommand\rpi{}{\ensuremath{r_{\pi}}\xspace}
% TODO: add Vth, Vbe, \gnd, \npn, \pnp, RL, \VT and \VTH (MOSFET threshold voltage), \BF (and what other betas?), \VGS, \VDS, \VCC, \VEE, \VDD, \VSS, \Vov for MOSFET overdrive
